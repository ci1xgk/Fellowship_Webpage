...
See the "3. Valley flooding following a dam failure" or "4. Carlistle 2005, urban flooding" case studies for a demontrastion of how to set up `.bdy` file for the `.bci` file. 
