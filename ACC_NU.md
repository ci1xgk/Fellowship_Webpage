...
The technical background of how the ACC solver is adapted on the non-uniform grid generated by the multiwavets Galerkin projection of the DEM, and parallised on the GPU can be found in the [preprint](https://gmd.copernicus.org/preprints/gmd-2022-259/), which provides a demonstration of the solver performance for five real-world fluvial/pluvial case studies.
