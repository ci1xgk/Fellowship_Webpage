...
* The error threshold parameter, *$\epsilon \varepsilon E$*, is selected by including item `epsilon`, followed by a float number refering to the value of the error threshold parameter.
